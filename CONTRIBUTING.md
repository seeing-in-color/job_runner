# Contributing to Job Runner

Thank you for your interest in contributing to Job Runner. This guide covers everything you need to get started.
...
```bash
git clone https://github.com/Pickle-Pixel/job_runner.git
cd job_runner
pip install -e ".[dev]"
playwright install chromium
```

This installs Job Runner in editable mode with all development dependencies (pytest, ruff, etc.) and downloads the Chromium browser binary for Playwright.
...
4. Test discovery: `job_runner discover --employer "Company Name"`
...
3. Test: `job_runner discover --site "Company Name"`
4. Submit a PR

### Bug Fixes and Features

1. Check existing [issues](https://github.com/Pickle-Pixel/job_runner/issues) to avoid duplicating work
...
# Run with coverage
pytest tests/ --cov=src/job_runner --cov-report=term-missing
```

## Linting and Code Style

Job Runner uses [Ruff](https://docs.astral.sh/ruff/) for linting and formatting.
...
By contributing to Job Runner, you agree that your contributions will be licensed under the [GNU Affero General Public License v3.0](LICENSE).
