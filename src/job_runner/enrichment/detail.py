...
from job_runner.database import get_connection, init_db, ensure_columns
...
def set_proxy(proxy_str: str | None):
    ...
    if proxy_str:
        from job_runner.discovery.jobspy import parse_proxy
...
def _load_base_urls() -> dict[str, str | None]:
    ...
    from job_runner.config import load_base_urls
...
def extract_with_llm(page, url: str) -> dict:
    ...
    try:
        ...
        from job_runner.discovery.smartextract import extract_json
