...
from job_runner.config import RESUME_PATH, RESUME_PDF_PATH, TAILORED_DIR, load_profile
from job_runner.database import get_connection, get_jobs_by_stage
from job_runner.llm import get_client
from job_runner.scoring.validator import (
    BANNED_WORDS,
    ...
    for job in jobs:
        ...
        try:
            ...
            if report["status"] in ("approved", "approved_with_judge_warning"):
                try:
                    from job_runner.scoring.pdf import convert_to_pdf
